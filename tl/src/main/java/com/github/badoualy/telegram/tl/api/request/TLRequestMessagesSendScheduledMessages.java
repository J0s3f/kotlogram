...
public class TLRequestMessagesSendScheduledMessages extends TLMethod<TLAbsUpdates> {
    public static final int CONSTRUCTOR_ID = 0xbd38850a;

    protected TLAbsInputPeer peer;

    protected TLIntVector id;

    private final String _constructor = "messages.sendScheduledMessages#bd38850a";

    public TLRequestMessagesSendScheduledMessages() {
    }

    public TLRequestMessagesSendScheduledMessages(TLAbsInputPeer peer, TLIntVector id) {
        this.peer = peer;
        this.id = id;
    }
