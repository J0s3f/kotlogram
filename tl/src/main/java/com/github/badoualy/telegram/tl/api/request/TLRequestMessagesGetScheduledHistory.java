...
public class TLRequestMessagesGetScheduledHistory extends TLMethod<TLAbsMessages> {
    public static final int CONSTRUCTOR_ID = 0xe2c2685b;

    protected TLAbsInputPeer peer;

    protected int hash;

    private final String _constructor = "messages.getScheduledHistory#e2c2685b";

    public TLRequestMessagesGetScheduledHistory() {
    }

    public TLRequestMessagesGetScheduledHistory(TLAbsInputPeer peer, int hash) {
        this.peer = peer;
        this.hash = hash;
    }
