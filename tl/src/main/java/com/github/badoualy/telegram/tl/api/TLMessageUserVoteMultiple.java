...
public class TLMessageUserVoteMultiple extends TLAbsMessageUserVote {
    public static final int CONSTRUCTOR_ID = 0xe8fe0de;

    protected TLVector<TLBytes> options;

    private final String _constructor = "messageUserVoteMultiple#e8fe0de";

    public TLMessageUserVoteMultiple() {
    }

    public TLMessageUserVoteMultiple(int userId, TLVector<TLBytes> options, int date) {
        this.userId = userId;
