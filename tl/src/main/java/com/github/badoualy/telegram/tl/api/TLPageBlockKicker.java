...
public class TLPageBlockKicker extends TLAbsPageBlock {
    public static final int CONSTRUCTOR_ID = 0x1e148390;

    protected TLAbsRichText text;

    private final String _constructor = "pageBlockKicker#1e148390";

    public TLPageBlockKicker() {
    }

    public TLPageBlockKicker(TLAbsRichText text) {
        this.text = text;
    }
