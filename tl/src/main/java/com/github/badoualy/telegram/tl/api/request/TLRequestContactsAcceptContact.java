...
public class TLRequestContactsAcceptContact extends TLMethod<TLAbsUpdates> {
    public static final int CONSTRUCTOR_ID = 0xf831a20f;

    protected TLAbsInputUser id;

    private final String _constructor = "contacts.acceptContact#f831a20f";

    public TLRequestContactsAcceptContact() {
    }

    public TLRequestContactsAcceptContact(TLAbsInputUser id) {
        this.id = id;
    }
