...
public class TLRequestMessagesSendVote extends TLMethod<TLAbsUpdates> {
    public static final int CONSTRUCTOR_ID = 0x10ea6184;
    ...
    private final String _constructor = "messages.sendVote#10ea6184";

    public TLRequestMessagesSendVote() {
    }

    public TLRequestMessagesSendVote(TLAbsInputPeer peer, int msgId, TLVector<TLBytes> options) {
        this.peer = peer;
        this.msgId = msgId;
