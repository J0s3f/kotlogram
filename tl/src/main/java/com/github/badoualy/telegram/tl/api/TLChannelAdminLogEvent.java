...
public class TLChannelAdminLogEvent extends TLObject {
    ...
    private final String _constructor = "channelAdminLogEvent#0";

    public TLChannelAdminLogEvent() {
    }

    public TLChannelAdminLogEvent(long id, int date, int userId, TLAbsChannelAdminLogEventAction action) {
        this.id = id;
        this.date = date;
        this.userId = userId;
        this.action = action;
