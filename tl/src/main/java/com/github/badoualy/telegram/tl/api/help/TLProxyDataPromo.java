...
public class TLProxyDataPromo extends TLAbsProxyData {
    ...
    private final String _constructor = "help.proxyDataPromo#0";

    public TLProxyDataPromo() {
    }

    public TLProxyDataPromo(int expires, TLAbsPeer peer, TLVector<TLAbsChat> chats, TLVector<TLAbsUser> users) {
