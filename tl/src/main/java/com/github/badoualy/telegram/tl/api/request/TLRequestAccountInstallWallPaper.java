...
public class TLRequestAccountInstallWallPaper extends TLMethod<TLBool> {
    public static final int CONSTRUCTOR_ID = 0xfeed5769;

    protected TLAbsInputWallPaper wallpaper;

    protected TLWallPaperSettings settings;

    private final String _constructor = "account.installWallPaper#feed5769";

    public TLRequestAccountInstallWallPaper() {
    }

    public TLRequestAccountInstallWallPaper(TLAbsInputWallPaper wallpaper, TLWallPaperSettings settings) {
