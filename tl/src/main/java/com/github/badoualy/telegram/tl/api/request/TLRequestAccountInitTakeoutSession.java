...
public class TLRequestAccountInitTakeoutSession extends TLMethod<TLTakeout> {
    ...
    public TLRequestAccountInitTakeoutSession(boolean contacts, boolean messageUsers, boolean messageChats, boolean messageMegagroups, boolean messageChannels, boolean files, Integer fileMaxSize) {
