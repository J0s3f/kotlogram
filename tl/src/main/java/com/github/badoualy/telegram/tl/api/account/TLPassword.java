...
public class TLPassword extends TLObject {
    ...
    private final String _constructor = "account.password#0";

    public TLPassword() {
    }

    public TLPassword(boolean hasRecovery, boolean hasSecureValues, boolean hasPassword, TLAbsPasswordKdfAlgo currentAlgo, TLBytes srpB, Long srpId, String hint, String emailUnconfirmedPattern, TLAbsPasswordKdfAlgo newAlgo, TLAbsSecurePasswordKdfAlgo newSecureAlgo, TLBytes secureRandom) {
