...
public class TLSecureValueErrorSelfie extends TLAbsSecureValueError {
    public static final int CONSTRUCTOR_ID = 0xe537ced6;

    protected TLBytes fileHash;

    private final String _constructor = "secureValueErrorSelfie#e537ced6";

    public TLSecureValueErrorSelfie() {
    }

    public TLSecureValueErrorSelfie(TLAbsSecureValueType type, TLBytes fileHash, String text) {
        this.type = type;
