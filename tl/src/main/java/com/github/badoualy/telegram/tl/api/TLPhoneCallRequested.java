...
public class TLPhoneCallRequested extends TLAbsPhoneCall {
    public static final int CONSTRUCTOR_ID = 0x87eabb53;
    ...
    private final String _constructor = "phoneCallRequested#87eabb53";

    public TLPhoneCallRequested() {
    }

    public TLPhoneCallRequested(boolean video, long id, long accessHash, int date, int adminId, int participantId, TLBytes gAHash, TLPhoneCallProtocol protocol) {
        this.video = video;
        this.id = id;
