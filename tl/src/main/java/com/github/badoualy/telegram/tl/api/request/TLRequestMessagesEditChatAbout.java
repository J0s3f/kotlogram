...
public class TLRequestMessagesEditChatAbout extends TLMethod<TLBool> {
    public static final int CONSTRUCTOR_ID = 0xdef60797;

    protected TLAbsInputPeer peer;

    protected String about;

    private final String _constructor = "messages.editChatAbout#def60797";

    public TLRequestMessagesEditChatAbout() {
    }

    public TLRequestMessagesEditChatAbout(TLAbsInputPeer peer, String about) {
        this.peer = peer;
        this.about = about;
    }
