...
public class TLRequestAccountSetContentSettings extends TLMethod<TLBool> {
    public static final int CONSTRUCTOR_ID = 0xb574b16b;

    protected int flags;

    protected boolean sensitiveEnabled;

    private final String _constructor = "account.setContentSettings#b574b16b";

    public TLRequestAccountSetContentSettings() {
    }

    public TLRequestAccountSetContentSettings(boolean sensitiveEnabled) {
