...
public class TLRequestChannelsEditBanned extends TLMethod<TLAbsUpdates> {
    public static final int CONSTRUCTOR_ID = 0x72796912;
    ...
    private final String _constructor = "channels.editBanned#72796912";

    public TLRequestChannelsEditBanned() {
    }

    public TLRequestChannelsEditBanned(TLAbsInputChannel channel, TLAbsInputUser userId, TLChatBannedRights bannedRights) {
