...
public class TLRequestAccountAcceptAuthorization extends TLMethod<TLBool> {
    ...
    private final String _constructor = "account.acceptAuthorization#0";

    public TLRequestAccountAcceptAuthorization() {
    }

    public TLRequestAccountAcceptAuthorization(int botId, String scope, String publicKey, TLVector<TLSecureValueHash> valueHashes, TLSecureCredentialsEncrypted credentials) {
        this.botId = botId;
        this.scope = scope;
