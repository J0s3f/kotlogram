...
public class TLChannelAdminLogEventActionChangeLinkedChat extends TLAbsChannelAdminLogEventAction {
    public static final int CONSTRUCTOR_ID = 0xa26f881b;

    protected int prevValue;

    protected int newValue;

    private final String _constructor = "channelAdminLogEventActionChangeLinkedChat#a26f881b";

    public TLChannelAdminLogEventActionChangeLinkedChat() {
    }

    public TLChannelAdminLogEventActionChangeLinkedChat(int prevValue, int newValue) {
