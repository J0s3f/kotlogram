...
public class TLRequestMessagesEditChatDefaultBannedRights extends TLMethod<TLAbsUpdates> {
    public static final int CONSTRUCTOR_ID = 0xa5866b41;

    protected TLAbsInputPeer peer;

    protected TLChatBannedRights bannedRights;

    private final String _constructor = "messages.editChatDefaultBannedRights#a5866b41";

    public TLRequestMessagesEditChatDefaultBannedRights() {
    }

    public TLRequestMessagesEditChatDefaultBannedRights(TLAbsInputPeer peer, TLChatBannedRights bannedRights) {
        this.peer = peer;
