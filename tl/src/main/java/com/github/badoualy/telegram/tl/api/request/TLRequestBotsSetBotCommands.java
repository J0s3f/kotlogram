...
public class TLRequestBotsSetBotCommands extends TLMethod<TLBool> {
    public static final int CONSTRUCTOR_ID = 0x805d46f6;

    protected TLVector<TLBotCommand> commands;

    private final String _constructor = "bots.setBotCommands#805d46f6";

    public TLRequestBotsSetBotCommands() {
    }

    public TLRequestBotsSetBotCommands(TLVector<TLBotCommand> commands) {
