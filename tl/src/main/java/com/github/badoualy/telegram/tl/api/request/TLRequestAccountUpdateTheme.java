...
public class TLRequestAccountUpdateTheme extends TLMethod<TLTheme> {
    public static final int CONSTRUCTOR_ID = 0x5cb367d5;
    ...
    protected TLInputThemeSettings settings;

    private final String _constructor = "account.updateTheme#5cb367d5";

    public TLRequestAccountUpdateTheme() {
    }

    public TLRequestAccountUpdateTheme(String format, TLAbsInputTheme theme, String slug, String title, TLAbsInputDocument document, TLInputThemeSettings settings) {
        this.format = format;
        this.theme = theme;
        this.slug = slug;
        this.title = title;
    ...
    public void deserializeBody(InputStream stream, TLContext context) throws IOException {
        ...
        settings = (flags & 8) != 0 ? readTLObject(stream, context, TLInputThemeSettings.class, TLInputThemeSettings.CONSTRUCTOR_ID) : null;
    }
